...
@Observable @MainActor public final class AppSettings {
    ...
    /// The unit used to display and enter weights. Stored weights are always kilograms.
    public var weightUnit: WeightUnit {
        didSet {
            store.save(weightUnit, for: .weightUnit)
        }
    }
    ...
    public init(store: AnyKeyValueStore<AppSettings.Key>? = nil) {
        ...
        weightUnit = self.store.load(.weightUnit, default: .kg)
